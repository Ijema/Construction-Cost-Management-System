    ...
    <div class="sidebar pb-4 mb-4">
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false">
           ...
           <li class="nav-item">
                <a href="#" class="nav-link nav-estimates">
				 ...
				 <ul class="nav nav-treeview">
					<li class="nav-item">
						<a href="./index.php?page=estimates" class="nav-link nav-estimates tree-item">
						<i class="fas fa-angle-right nav-icon"></i>
						<p>Estimate</p>
						</a>
					</li>
					<li class="nav-item">
						<a href="./index.php?page=estimate_list" class="nav-link nav-estimate_list tree-item">
						<i class="fas fa-angle-right nav-icon"></i>
						<p>Estimate_list</p>
						</a>
					</li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="./index.php?page=assign_tasks" class="nav-link nav-assign_tasks tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Assign tasks</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="./index.php?page=assign_tasks" class="nav-link nav-assigned_tasks tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Assigned tasks</p>
                </a>
              </li>
        ...
        <?php endif; ?>
		   <?php if($_SESSION['login_type'] == "Admin"): ?>
           <li class="nav-item">
                <a href="./index.php?page=log" class="nav-link nav-log">

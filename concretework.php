...
<div class="row">
			...
			<table>
				...
				echo '<tr><th colspan="6"><label for="plot_size">Columns, Lintels, Beams, Floor, Slabs, Staircase, Roof Beams, Roof Slab</label></th></tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
						echo '<td><input type="text" id="materials" name="materials" value = "Cement" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
						echo '<td><input id="materials1" type="text" name="materials1" value = "Sharp Sand (10 tyres tipper)" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
						echo '<td><input id="materials2" type="text" name="materials2" value = "Granite (20 tons tipper)" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
						echo '<td><input id="materials3" type="text" name="materials3" value = "Labour For Casting" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				...
				echo '<tr><td colspan="6"><label>Reinforcement</label></td>';
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
						echo '<td><input id="materials4" type="text" name="materials4" value = "16mm Diameter High Yield Bar" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
						echo '<td><input id="materials5" type="text" name="materials5" value = "12mm Ditto" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
						echo '<td><input id="materials6" type="text" name="materials6" value = "10mm Ditto" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
						echo '<td><input id="materials7" type="text" name="materials7" value = "Binding Wire" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
						echo '<td><input id="materials8" type="text" name="materials8" value = "Iron Benders" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				...
				echo '<tr><th><label for="plot_size">Formwork</label></th></tr>';
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
						echo '<td><input id="materials9" type="text" name="materials9" value = "1 x12 x12 Planks" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
						echo '<td><input id="materials10" type="text" name="materials10" value = "2 x3 x12 Planks" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
						echo '<td><input id="materials11" type="text" name="materials11" value = "Bamboo" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
						echo '<td><input id="materials12" type="text" name="materials12" value = "Labour" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
						echo '<td><input id="materials13" type="text" name="materials13" value = "2"" style = "border:none; background-color:#F6F2FF" readonly /></td>';
						echo '<td><input style = "width:150px" id="qty13" type="number" name="qty13" value ="<?php echo isset($qty13) ?>" onkeyup="sum()"/></td>';
						echo '<td><input  style = "width:150px" id="unit13" type="text" name="unit13" value = "Inch" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
						echo '<td><input id="materials14" type="text" name="materials14" value = "3"" style = "border:none; background-color:#F6F2FF" readonly /></td>';
						echo '<td><input style = "width:150px" id="qty14" type="number" name="qty14" value ="<?php echo isset($qty14)?>" onkeyup="sum()"/></td>';
						echo '<td><input  style = "width:150px" id="unit14" type="text" name="unit14" value = "Inch" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
						echo '<td><input id="materials15" type="text" name="materials15" value = "4"" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
						echo '<td><input id="materials16" type="text" name="materials16" value = "Capenters" style = "border:none; background-color:#F6F2FF" readonly /></td>';
    ...
    <div> Total Estimate <input id="concreteworkresult" name="concreteworkresult" type="number" readonly ></div>
 ...
 <script type="text/javascript">
        function sum() {
			...
			var result = parseInt(total) + parseInt(total1) + parseInt(total2)+ parseInt(total3)+ parseInt(total4)+ parseInt(total5)+ parseInt(total6) + parseInt(total7)+ parseInt(total8)+ parseInt(total9)+ parseInt(total10)+ parseInt(total11)+ parseInt(total12)+ parseInt(total13) + parseInt(total14)+ parseInt(total15)+ parseInt(total16);
            
			if (!isNaN(result)) {
				document.getElementById("concreteworkresult").value = result ;
			}
		}
...
$('#submitform').submit(function(e){
    	...
    	start_load()
    	$.ajax({
    		url:'ajax.php?action=save_secondestimate',

...
<div class="row">
	...
	<div class="card-body">
			<table class="table tabe-hover table-condensed" id="list">
				...
				echo '<td><input id="materials" type="text" name="materials" value = "Complete Set of Sweethomes Water Closet and Wash Hand Basin" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials1" type="text" name="materials1" value = "TwyFord wash hand basin complete" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				echo '<td><input style = "width:150px" id="qty1" type="number" name="qty1" value ="<?php echo isset($qty1)?>" onkeyup="sum()"/></td>';
				echo '<td><input  style = "width:150px" id="unit1" type="text" name="unit1" value = "N/r" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials2" type="text" name="materials2" value = "Double Bowl Double Drain Stainless Sink with Taps Complete" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				echo '<td><input style = "width:150px" id="qty2" type="number" name="qty2" value ="<?php echo isset($qty2)?>" onkeyup="sum()"/></td>';
				echo '<td><input  style = "width:150px" id="unit2" type="text" name="unit2" value = "N/r" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials3" type="text" name="materials3" value = "30 Litres sweethomes water heaters complete" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials4" type="text" name="materials4" value = "Shower poles and Mixers complete" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials5" type="text" name="materials5" value = "Toilet acessories complete" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				echo '<td><input style = "width:150px" id="qty5" type="number" name="qty5" value ="<?php echo isset($qty5)?>" onkeyup="sum()"/></td>';
				echo '<td><input  style = "width:150px" id="unit5" type="text" name="unit5" value = "N/r" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials6" type="text" name="materials6" value = "Purposed Made 10mm thick Frameless tampered Glass Shower Glass Cubicles With Sliding Doors Complete" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				echo '<td><input style = "width:150px" id="qty6" type="number" name="qty6" value ="<?php echo isset($qty6)?>" onkeyup="sum()"/></td>';
				echo '<td><input  style = "width:150px" id="unit6" type="text" name="unit6" value = "N/r" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials7" type="text" name="materials7" value = "Laundary basin double bows" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials8" type="text" name="materials8" value = "6 Hornet extraction fan complete" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials9" type="text" name="materials9" value = "Kitchen Mixer" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials10" type="text" name="materials10" value = "Basin mixer" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials11" type="text" name="materials11" value = "Magic waste" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials12" type="text" name="materials12" value = "Anus wash" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials13" type="text" name="materials13" value = "Angle valves" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				echo '<td><input style = "width:150px" id="qty13" type="number" name="qty13" value ="<?php echo isset($qty13)?>" onkeyup="sum()"/></td>';
				echo '<td><input  style = "width:150px" id="unit13" type="text" name="unit13" value = "N/r" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials14" type="text" name="materials14" value = "Sensor tap" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				echo '<td><input style = "width:150px" id="qty14" type="number" name="qty14" value ="<?php echo isset($qty14)?>" onkeyup="sum()"/></td>';
				echo '<td><input  style = "width:150px" id="unit14" type="text" name="unit14" value = "N/r" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials15" type="text" name="materials15" value = "13mm Diameter tap" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				echo '<td><input style = "width:150px" id="qty15" type="number" name="qty15" value ="<?php echo isset($qty15)?>" onkeyup="sum()"/></td>';
				echo '<td><input  style = "width:150px" id="unit15" type="text" name="unit15" value = "N/r" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials16" type="text" name="materials16" value = "13mm Diameter long neck tap" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				echo '<td><input style = "width:150px" id="qty16" type="number" name="qty16" value ="<?php echo isset($qty16)?>" onkeyup="sum()"/></td>';
				echo '<td><input  style = "width:150px" id="unit16" type="text" name="unit16" value = "N/r" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials17" type="text" name="materials17" value = "Copper flex" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				echo '<td><input style = "width:150px" id="qty17" type="number" name="qty17" value ="<?php echo isset($qty17)?>" onkeyup="sum()"/></td>';
				echo '<td><input  style = "width:150px" id="unit17" type="text" name="unit17" value = "N/r" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials18" type="text" name="materials18" value = "Copper nipple" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				echo '<td><input style = "width:150px" id="qty18" type="number" name="qty18" value ="<?php echo isset($qty18)?>" onkeyup="sum()"/></td>';
				echo '<td><input  style = "width:150px" id="unit18" type="text" name="unit18" value = "N/r" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials19" type="text" name="materials19" value = "Shower rose" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				...
				echo '<th colspan="6"><label>Aircondition System</label></th>';
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials20" type="text" name="materials20" value = "Supply and Fix A/C Refrigerant PVC Sleeve Pipes, Copper Pipes, Water Hose, Flexible Wires, Amoflexi Tube in Walls to Outdoor Condensing Unit and Make Good Disturbed Surface. " style = "border:none; background-color:#F6F2FF" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials21" type="text" name="materials21" value = "Labour for piping and installation of air conditioner" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				...
				echo '<th colspan="6"><label>Cold and hot water pipes</label></th>';
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials22" type="text" name="materials22" value = "38mm Diameter pipe" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				echo '<td><input style = "width:150px" id="qty22" type="number" name="qty22" value ="<?php echo isset($qty22)?>" onkeyup="sum()"/></td>';
				echo '<td><input  style = "width:150px" id="unit22" type="text" name="unit22" value = "mm" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials23" type="text" name="materials23" value = "25mm Ditto" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				echo '<td><input style = "width:150px" id="qty23" type="number" name="qty23" value ="<?php echo isset($qty23)?>" onkeyup="sum()"/></td>';
				echo '<td><input  style = "width:150px" id="unit23" type="text" name="unit23" value = "mm" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials24" type="text" name="materials24" value = "Gum Royal" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				echo '<td><input style = "width:150px" id="qty24" type="number" name="qty24" value ="<?php echo isset($qty24)?>" onkeyup="sum()"/></td>';
				echo '<td><input  style = "width:150px" id="unit24" type="text" name="unit24" value = "Gallon" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials25" type="text" name="materials25" value = "19mm Ditto" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				echo '<td><input style = "width:150px" id="qty25" type="number" name="qty25" value ="<?php echo isset($qty25)?>" onkeyup="sum()"/></td>';
				echo '<td><input  style = "width:150px" id="unit25" type="text" name="unit25" value = "mm" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials26" type="text" name="materials26" value = "Copper pipe" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials27" type="text" name="materials27" value = "38mm Diamond elbow" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				echo '<td><input style = "width:150px" id="qty27" type="number" name="qty27" value ="<?php echo isset($qty27)?>" onkeyup="sum()"/></td>';
				echo '<td><input  style = "width:150px" id="unit27" type="text" name="unit27" value = "mm" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials28" type="text" name="materials28" value = "25mm ditto" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				echo '<td><input style = "width:150px" id="qty28" type="number" name="qty28" value ="<?php echo isset($qty28)?>" onkeyup="sum()"/></td>';
				echo '<td><input  style = "width:150px" id="unit28" type="text" name="unit28" value = "mm" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials29" type="text" name="materials29" value = "19mm Ditto" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials30" type="text" name="materials30" value = "19mm x 13mm Diameter white M/F" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				echo '<td><input style = "width:150px" id="qty30" type="number" name="qty30" value ="<?php echo isset($qty30)?>" onkeyup="sum()"/></td>';
				echo '<td><input  style = "width:150px" id="unit30" type="text" name="unit30" value = "mm" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials31" type="text" name="materials31" value = "Copper Elbow" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials32" type="text" name="materials32" value = "M/F Copper elbow" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				...
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials33" type="text" name="materials33" value = "Copper Tee" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				echo '<td><input style = "width:150px" id="qty33" type="number" name="qty33" value ="<?php echo isset($qty33)?>" onkeyup="sum()"/></td>';
				echo '<td><input  style = "width:150px" id="unit33" type="text" name="unit33" value = "mm" readonly /></td>';
				...
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials34" type="text" name="materials34" value = "38mm Diameter tee" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				echo '<td><input style = "width:150px" id="qty34" type="number" name="qty34" value ="<?php echo isset($qty34)?>" onkeyup="sum()"/></td>';
				echo '<td><input  style = "width:150px" id="unit34" type="text" name="unit34" value = "mm" readonly /></td>';
				...
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials35" type="text" name="materials35" value = "19mm Ditto" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				echo '<td><input style = "width:150px" id="qty35" type="number" name="qty35" value ="<?php echo isset($qty35)?>" onkeyup="sum()"/></td>';
				echo '<td><input  style = "width:150px" id="unit35" type="text" name="unit35" value = "mm" readonly /></td>';
				...
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials36" type="text" name="materials36" value = "25mm Diameter Adopter" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				echo '<td><input style = "width:150px" id="qty36" type="number" name="qty36" value ="<?php echo isset($qty36)?>" onkeyup="sum()"/></td>';
				echo '<td><input  style = "width:150px" id="unit36" type="text" name="unit36" value = "M" readonly /></td>';
				...
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials37" type="text" name="materials37" value = "19mm Ditto" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				echo '<td><input style = "width:150px" id="qty37" type="number" name="qty37" value ="<?php echo isset($qty37)?>" onkeyup="sum()"/></td>';
				echo '<td><input  style = "width:150px" id="unit37" type="text" name="unit37" value = "M" readonly /></td>';
				...
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials38" type="text" name="materials38" value = "25mm Diameter stop cork" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				echo '<td><input style = "width:150px" id="qty38" type="number" name="qty38" value ="<?php echo isset($qty38)?>" onkeyup="sum()"/></td>';
				echo '<td><input  style = "width:150px" id="unit38" type="text" name="unit38" value = "mm" readonly /></td>';
				...
				echo '<th colspan="6"><label>Drain Pipes and Fittings</label></th>';
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials39" type="text" name="materials39" value = "100mm Diameter Pipe" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				echo '<td><input style = "width:150px" id="qty39" type="number" name="qty39" value ="<?php echo isset($qty39)?>" onkeyup="sum()"/></td>';
				echo '<td><input  style = "width:150px" id="unit39" type="text" name="unit39" value = "mm" readonly /></td>';
				...
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials40" type="text" name="materials40" value = "100mm Diameter Elbow" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				echo '<td><input style = "width:150px" id="qty40" type="number" name="qty40" value ="<?php echo isset($qty40)?>" onkeyup="sum()"/></td>';
				echo '<td><input  style = "width:150px" id="unit40" type="text" name="unit40" value = "mm" readonly /></td>';
				...
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials41" type="text" name="materials41" value = "500mm Ditto" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				echo '<td><input style = "width:150px" id="qty41" type="number" name="qty41" value ="<?php echo isset($qty41)?>" onkeyup="sum()"/></td>';
				echo '<td><input  style = "width:150px" id="unit41" type="text" name="unit41" value = "mm" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials42" type="text" name="materials42" value = "100mm Diameter Tee" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				echo '<td><input style = "width:150px" id="qty42" type="number" name="qty42" value ="<?php echo isset($qty42)?>" onkeyup="sum()"/></td>';
				echo '<td><input  style = "width:150px" id="unit42" type="text" name="unit42" value = "mm" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials43" type="text" name="materials43" value = "Stainless Steel; 500mm Diameter floor drain" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				echo '<td><input style = "width:150px" id="qty43" type="number" name="qty43" value ="<?php echo isset($qty43)?>" onkeyup="sum()"/></td>';
				echo '<td><input  style = "width:150px" id="unit43" type="text" name="unit43" value = "mm" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials44" type="text" name="materials44" value = "100mm Diamater pan connector" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				echo '<td><input style = "width:150px" id="qty44" type="number" name="qty44" value ="<?php echo isset($qty44)?>" onkeyup="sum()"/></td>';
				echo '<td><input  style = "width:150px" id="unit44" type="text" name="unit44" value = "mm" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials45" type="text" name="materials45" value = "13 Diamater; PVC flexible connectors" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				echo '<td><input style = "width:150px" id="qty45" type="number" name="qty45" value ="<?php echo isset($qty45)?>" onkeyup="sum()"/></td>';
				echo '<td><input  style = "width:150px" id="unit45" type="text" name="unit45" value = "M" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials46" type="text" name="materials46" value = "13mm Diamater; Press cable" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				echo '<td><input style = "width:150px" id="qty46" type="number" name="qty46" value ="<?php echo isset($qty46)?>" onkeyup="sum()"/></td>';
				echo '<td><input  style = "width:150px" id="unit46" type="text" name="unit46" value = "M" readonly /></td>';
				...
				echo '<th colspan="6"><label>Gum</label></th>';
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials47" type="text" name="materials47" value = "Abro gum" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				echo '<td><input style = "width:150px" id="qty47" type="number" name="qty47" value ="<?php echo isset($qty47)?>" onkeyup="sum()"/></td>';
				echo '<td><input  style = "width:150px" id="unit47" type="text" name="unit47" value = "gallon" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials48" type="text" name="materials48" value = "Tread tape" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				echo '<td><input style = "width:150px" id="qty48" type="number" name="qty48" value ="<?php echo isset($qty48)?>" onkeyup="sum()"/></td>';
				echo '<td><input  style = "width:150px" id="unit48" type="text" name="unit48" value = "M" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials49" type="text" name="materials49" value = "Gasket gum" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				echo '<td><input style = "width:150px" id="qty49" type="number" name="qty49" value ="<?php echo isset($qty49)?>" onkeyup="sum()"/></td>';
				echo '<td><input  style = "width:150px" id="unit49" type="text" name="unit49" value = "Gallon" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials50" type="text" name="materials50" value = "Silicon Gum" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				echo '<td><input style = "width:150px" id="qty50" type="number" name="qty50" value ="<?php echo isset($qty50)?>" onkeyup="sum()"/></td>';
				echo '<td><input  style = "width:150px" id="unit50" type="text" name="unit50" value = "Gallon" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials51" type="text" name="materials51" value = "Builders works in connectionnn with all piping works" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				echo '<td><input style = "width:150px" id="qty51" type="number" name="qty51" value ="<?php echo isset($qty51)?>" onkeyup="sum()"/></td>';
				echo '<td><input  style = "width:150px" id="unit51" type="text" name="unit51" value = "N/r" readonly /></td>';
				...
				echo '<tr>';
				echo '<th class="text-center"><?php echo $i++ ?></th>';
				echo '<td><input id="materials52" type="text" name="materials52" value = "Ditto fixing of fittings" style = "border:none; background-color:#F6F2FF" readonly /></td>';
				echo '<td><input style = "width:150px" id="qty52" type="number" name="qty52" value ="<?php echo isset($qty52)?>" onkeyup="sum()"/></td>';
				echo '<td><input  style = "width:150px" id="unit52" type="text" name="unit52" value = "N/r" readonly /></td>';
     ...
     <div>
        <td> Total Estimate <input id="mechanical_services_result" name="mechanical_services_result" type="number" readonly /></td>
    </div>
				<div class="d-flex w-100 justify-content-center align-items-center">
    			<input type="submit" class="btn btn-flat  bg-gradient-primary mx-2" value="Save" name="submit11">
...
document.getElementById("contract_code").value = contract_code ;
 ...
 $('#submitform').submit(function(e){
    	...
    	start_load()
    	$.ajax({
    		url:'ajax.php?action=save_mechanical_services_estimate',
